...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/30 13:46:15 by sfidan            #+#    #+#             */
/*   Updated: 2022/08/30 13:46:17 by sfidan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*get_next_line(int fd)
{
	...
	if (!buf[fd])
		return (0);
	line = ft_crop_line(buf[fd], ft_char_loc(buf[fd], '\n', 0));
	buf[fd] = ft_crop_next(buf[fd], buf[fd] + ft_char_loc(buf[fd], '\n', 0));
	return (line);
}
